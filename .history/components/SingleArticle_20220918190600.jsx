  ...
  return (
    <div className='px-4 py-24'>
      <div className='mx-auto max-w-prose'>
        ...
        <h1 className='mt-2 block text-center text-3xl font-extrabold leading-8 tracking-wide text-indigo-900 sm:text-4xl'>
          {title}
        </h1>
        <br />
        <Image
        ...
        <div className='flex items-center '>
          <Image src={author.image} width={100} height={100} alt='author' />
