...
The transatlantic trade mechanism: 
 ...
 - In the Americas and Islands: importations off commodities from Africa => essentially the Slaves being shipped for cultivating the exporting products to Europe in exchange of imported goods by European merchants.
